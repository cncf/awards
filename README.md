...
- **Top End User**: The special award for the [CNCF End User Community](https://www.cncf.io/enduser/) representatives in recognition of major contributions to the cloud native ecosystem. All end users who have written a case study, submitted a video spotlight, or won a case study contest at any KubeCon + CloudNativeCon within that same year are automatically nominated. Please note, end user members can not win two consecutive years in a row.
